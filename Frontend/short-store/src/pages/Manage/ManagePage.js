            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell align="center">최근 접속일</StyledTableCell>
              ...
              <TableBody>
                {rows.map((row) => (
                  <StyledTableRow key={row.name}>
                    ...
                    <StyledTableCell align="center">{row.member_since}</StyledTableCell>
                    <StyledTableCell align="center">{row.last_access}</StyledTableCell>
                    <StyledTableCell align="center">{row.management}</StyledTableCell>
                  </StyledTableRow>
                ))}
              </TableBody>
            </Table>
